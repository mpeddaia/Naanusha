...
public class GetTopLevelWBSTest {
	...
	public static void main(String[] args) {
		...
		org.junit.runner.JUnitCore
				.main("com.cisco.primavera.api.GetTopLevelWBSTest");
	}
	 ...
	 */
	@Test
	public void testGetTopLevelWBSByPid() throws ServerException, NetworkException, ClientException {
		
		String projectNumber ="714214";//pid 731765--dv1spm for customer info  //
		String excludeWbsCodes = "";
		String wbsName = "";
		ProjectProfileResponse response = GetTopLevelWbs.getTopLevelWbs(projectNumber, excludeWbsCodes, wbsName);				
	...
	public void testGetErrorDetailsForInvalidPid() throws ServerException, NetworkException, ClientException {
		...
		String excludeWbsCodes = "Pre-Sales,Travel";
		String wbsName = "";
		String transId = "";
		ProjectProfileResponse response = GetTopLevelWbs.getTopLevelWbs(projectNumber, excludeWbsCodes, wbsName);
	 ...
	 * @author Parasoft Jtest 9.5
	 */
	public Class<GetTopLevelWBSTest> getTestedClass() {
		return GetTopLevelWBSTest.class;
	}
